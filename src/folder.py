...
class Folder():
    ...
    def __init__(self, path):
        ...
        self.image = pygame.image.load(f"{self.installing_path}/images/folder.png")
        if os.path.dirname(self.path) == "/home":
            self.image = pygame.image.load(f"{self.installing_path}/images/personal.png")
